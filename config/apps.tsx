...
import { Terminal, Folder, Globe, Calculator, Settings, CodeSquare, CloudSun, FileText, CheckSquare } from 'lucide-react';

export const SYSTEM_APPS = [
  { id: 'browser', title: 'Nebula Edge', icon: <Globe size={16} /> },
  { id: 'files', title: 'Files', icon: <Folder size={16} /> },
  { id: 'notes', title: 'Notes', icon: <FileText size={16} /> },
  { id: 'todos', title: 'Tasks', icon: <CheckSquare size={16} /> },
